...
export default function Home(){
    return(
        <>
        <Banner h1={"Telescopio espacial James Webb"} src={"telescopio-espacial-james-webb.webp"} alt={"Telescopio espacial James Webb"} p={`O Telescópio Espacial James Webb, em inglês James Webb Space Telescope (JWST), é um telescópio espacial projetado pela Nasa em colaboração com a Agência Espacial Europeia (ESA) e a Agência Espacial Canadiana (CSA) com o intuito de substituir o Telescópio Espacial Hubble. 
